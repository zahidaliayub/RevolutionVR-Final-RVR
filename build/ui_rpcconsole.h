...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        gridLayout->addWidget(numberOfConnections, 6, 1, 1, 1);
        ...
        gridLayout->addWidget(isTestNet, 7, 1, 1, 1);
        ...
        gridLayout->addWidget(numberOfBlocks, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(totalBlocks, 10, 1, 1, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "RevolutionVR - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "RevolutionVR Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the RevolutionVR debug logfile from the current data directory. This can take a few seconds for large logfiles.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the RevolutionVR-Qt help message to get a list with possible RevolutionVR command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
