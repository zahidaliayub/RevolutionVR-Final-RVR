...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // From Litecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
unsigned int static KimotoGravityWell(const CBlockIndex* pindexLast, const CBlock *pblock, uint64_t TargetBlocksSpacingSeconds, uint64_t PastBlocksMin, uint64_t PastBlocksMax) {
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfc8c2d66674b632c8a6e3b630a056094297ba92d4e4d05481df8297f0165b77c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1442720605;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1536446;

        if (fTestNet)
        {
            block.nTime    = 1442662822;
            block.nNonce   = 62851;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1f50b7e93cbfe4f6240e3089d66d22c4b1f5832a52d50645138564c5fd81b0ad"));
